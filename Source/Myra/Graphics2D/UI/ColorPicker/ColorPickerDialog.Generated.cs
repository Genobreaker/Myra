/* Generated by Myra UI Editor at 18.10.2018 23:52:44 */
...
namespace Myra.Graphics.UI.ColorPicker
{
	partial class ColorPickerDialog
	{
		private void BuildUI()
		{
			...
			grid4.ColumnSpacing = 4;
			grid4.RowSpacing = 4;
			grid4.ColumnsProportions.Add(new Grid.Proportion
			{
				Type = Myra.Graphics2D.UI.Grid.ProportionType.Part,
			});
			grid4.ColumnsProportions.Add(new Grid.Proportion
			...
			grid4.GridSelectionMode = Myra.Graphics2D.UI.GridSelectionMode.Cell;
			grid4.HeightHint = 70;
			...
			grid5.GridPositionY = 4;
			grid5.Widgets.Add(grid4);
			grid5.Widgets.Add(_buttonSaveColor);
			...
			var grid6 = new Grid();
			grid6.DrawLinesColor = Color.White;
			grid6.RowSpacing = 4;
			grid6.RowsProportions.Add(new Grid.Proportion
			{
				Type = Myra.Graphics2D.UI.Grid.ProportionType.Fill,
				Value = 100,
			});
			...
			grid6.RowsProportions.Add(new Grid.Proportion());
			grid6.RowsProportions.Add(new Grid.Proportion());
			grid6.HorizontalAlignment = Myra.Graphics2D.UI.HorizontalAlignment.Stretch;
			grid6.VerticalAlignment = Myra.Graphics2D.UI.VerticalAlignment.Stretch;
			grid6.GridPositionY = 1;
			grid6.Widgets.Add(_imageColor);
			grid6.Widgets.Add(horizontalSeparator1);
			grid6.Widgets.Add(grid3);
			grid6.Widgets.Add(horizontalSeparator2);
			grid6.Widgets.Add(grid5);
			grid6.Widgets.Add(horizontalSeparator3);
